...
function ComboboxTrigger({
  className,
  children,
  icon = <ChevronDownIcon className="pointer-events-none size-3.5 text-muted-foreground" />,
  ...props
}: ComboboxPrimitive.Trigger.Props & { icon?: React.ReactNode }) {
  return (
      ...
      <InputGroupAddon align="inline-end">
        {showTrigger && (
          <InputGroupButton
            size="icon-xs"
            variant="ghost"
            render={<ComboboxTrigger icon={triggerIcon} />}
